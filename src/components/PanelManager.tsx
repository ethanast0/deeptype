...
const PanelManager: React.FC<PanelManagerProps> = ({ className }) => {
  const { user } = useAuth();
  ...
  return (
    <div className={`panel-manager space-y-4 ${className}`}>
      <div className="flex justify-between items-center mb-2">
        <h2 className="text-xl font-medium text-gray-300">Your Statistics</h2>
        <Button 
      ...
      {isLoading ? (
        <div className="text-center py-8 text-gray-400">Loading your panels...</div>
      ) : panels.length === 0 ? (
