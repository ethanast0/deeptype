...
const PanelManager: React.FC<PanelManagerProps> = ({
  ...
  return <div className={`panel-manager space-y-4 ${className}`}>
      <div className="flex justify-between items-center -mt-12">
        <Button onClick={() => setIsAddPanelOpen(true)} variant="ghost" className="w-full flex items-center gap-2 font-normal rounded-sm text-base rounded-sm text-zinc-400 bg-transparent">
