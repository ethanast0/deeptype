  ...
  return (
    <div className={cn("typing-area-container", className)}>
      ...
      <div className="flex gap-4 mt-8">
        <button 
          onClick={resetTest} 
          className="button font-normal bg-gray-950 hover:bg-gray-800 text-gray-500"
        >
          Reset
        </button>
        <button 
          onClick={loadNewQuote} 
          className="button button-accent bg-slate-950 hover:bg-slate-800 text-gray-500 font-normal text-base"
        >
          New (Shift + Enter)
        </button>
      </div>
